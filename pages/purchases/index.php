        ...
        <tbody id="purchases-table-body">
            ...
            ?>
                <tr class="**:text-sm **:text-nowrap">
                    <td class="border-b border-b-zinc-300 p-2 w-10"><input type="checkbox" name="id" id="checkbox-purchases-id" value="<?= $row['id'] ?>"></td>
                    ...
                    <td class="border-y border-y-zinc-300 p-2"><?= $row['total'] ?></td>
                    <td class="items-center border-y border-y-zinc-300 p-2 w-18 whitespace-nowrap text-center">
                        <div class="flex gap-3">
                            <a href="<?= BASEURL ?>/pages/purchases/edit.php?id=<?= $row['id'] ?>" class="transition-all duration-300 hover:bg-yellow-600 cursor-pointer bg-yellow-500 px-2 py-1 rounded-sm text-sm btn-update-purchase" data-id="<?= $row['id'] ?>">
