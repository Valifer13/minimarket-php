...
<div class="flex justify-between items-center mb-4">
    <h1 class="text-3xl font-medium tracking-tighter">Sales List</h1>
    <div class="flex gap-2 md:gap-4">
        <a href="<?= BASEURL ?>/pages/sales/add.php" class="flex gap-2 px-3 py-2 bg-blue-500 rounded-md items-center text-white text-sm tracking-tight cursor-pointer hover:bg-blue-600 transition-all duration-300 font-medium border-b-5 border-b-blue-800">
    ...
    <table class="table-auto w-full min:w-max">
        <thead>
            <tr class="text-zinc-400 *:text-sm *:text-start">
                ...
                <th class="border-b border-b-zinc-300 p-2">Cashier</th>
        ...
        <tbody id="purchases-table-body">
            ...
            ?>
                <tr class="**:text-sm **:text-nowrap">
                    ...
                    <td class="border-y border-y-zinc-300 p-2"><?= $row['cashier_name'] ?></td>
                    ...
                    <td class="items-center border-y border-y-zinc-300 p-2 w-18 whitespace-nowrap text-center">
                        <div class="flex gap-3">
                            <a href="<?= BASEURL ?>/pages/sales/transaction_details.php?id=<?= $row['id'] ?>" class="transition-all duration-300 hover:bg-yellow-600 cursor-pointer bg-yellow-500 px-2 py-1 rounded-sm text-sm btn-update-purchase" data-id="<?= $row['id'] ?>">
                            ...
                            <form action="<?= BASEURL ?>/process/sale_process.php" method="post" onsubmit="return confirm('Are you sure you want to delete?')">
