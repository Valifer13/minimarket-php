...
<div id="name-page" data-page="add-supplier" class="hidden"></div>
...
<div class="flex items-center gap-4 mb-8">
    ...
    <div class="flex flex-col gap-1">
        ...
        <h1 class="text-xl md:text-2xl lg:text-3xl font-medium tracking-tighter">Add New Supplier</h1>
    </div>
</div>
...
<form action="<?= BASEURL ?>/process/supplier_process.php" method="post">
    ...
    <div class="flex flex-col gap-8">
        <div class="w-full max-w-lg">
            ...
            <input type="text" name="name" id="name" class="w-full border border-zinc-300 rounded-md p-2 mt-1 focus:outline-none text-sm" placeholder="Supplier Name" required>
        </div>
        <div class="w-full max-w-lg">
            <label for="contact" class="text-sm text-zinc-500 font-medium">Contact</label>
            <input type="text" name="contact" id="contact" class="w-full border border-zinc-300 rounded-md p-2 mt-1 focus:outline-none text-sm" placeholder="XXXX-XXXX-XXXX" required>
        </div>
        <div class="w-full max-w-lg">
            <label for="address" class="text-sm text-zinc-500 font-medium">Address</label>
            <input type="text" name="address" id="address" class="w-full border border-zinc-300 rounded-md p-2 mt-1 focus:outline-none text-sm" placeholder="Supplier Address" required>
        </div>
