...
<form action="<?= BASEURL ?>/process/product_process.php" method="post" class="flex flex-col min-[1100px]:flex-row gap-5 mb-8 w-full">
    ...
    <div class="flex flex-col gap-6 w-full min-[1100px]:max-w-lg">
        ...
        <div class="flex flex-col gap-2 w-full">
            ...
            <div class="flex flex-col border-[1px] border-zinc-300 rounded-md p-4 gap-4">
                <div>
                    <label for="brand" class="text-sm text-zinc-500 font-medium">Brand</label>
                    <input list="brands" name="brand" id="brand" class="w-full border border-zinc-300 rounded-md p-2 mt-1 focus:outline-none text-sm" placeholder="Select brand" required autocomplete="off">
                    <datalist class="w-full border border-zinc-300 rounded-md p-2 mt-1 focus:outline-none text-sm" id="brands">
