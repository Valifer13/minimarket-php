    ...
    <table class="table-auto w-full min:w-max">
        <thead>
            <tr class="text-zinc-400 *:text-sm *:text-start">
                ...
                <!-- <th class="border-b border-b-zinc-300 p-2">Barcode</th> -->
                <th class="border-b border-b-zinc-300 p-2">Name</th>
                <th class="border-b border-b-zinc-300 p-2">Brand</th>
                <th class="border-b border-b-zinc-300 p-2">Category</th>
                <th class="border-b border-b-zinc-300 p-2">Buy Price</th>
                <th class="border-b border-b-zinc-300 p-2">Qty</th>
