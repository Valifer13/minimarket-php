...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!is_null($supplier_name) && $supplier_name != "") {
    ...
    if (!is_null($voucher_name) && $voucher_name != "") {
    ...
    if ($action == 'add') {
        $query = "INSERT INTO products
            (barcode, name, description, category_id, supplier_id, buy_price, sell_price, stock, voucher_id) VALUES
            ('$barcode', '$name', '$description', $category_id, $supplier_id, $buy_price, $sell_price, $stock, $voucher_id);
        ";
